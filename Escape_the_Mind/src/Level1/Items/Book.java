...
public class Book {
    ...
    public static void BookI(GUI gui){
        title = "The Gilded Grip";
        gui.printBookText("There is a tale of a merchant who touched too much gold. He had no vault, no lockbox, no guards—only a love for the shimmer. They say he counted his wealth with bare hands every night, whispering to each coin like a lover.\n" +
    ...
    public static void BookII(GUI gui){
        title = "The Blade Without Victory";
        gui.printBookText("The sword was perfect. Balanced. Keen. Forged in silence beneath a blood moon.\n" +
    ...
    public static void BookIII(GUI gui){
        title = "The Spores of the Mind";
        gui.printBookText("Deep beneath the redwood canopy, where light dares not linger, they grow: the sporecrowns.\n" +
    ...
    public static void BookIV(GUI gui){
        title = "On Stacks and Stillness";
        gui.printBookText("In old villages, they stacked the wood just so. Long rows. Neat corners. Never burned.\n" +
    ...
    public static void BookV(GUI gui){
        title = "The Hunger That Remains";
        gui.printBookText("The baker fed the whole town once. No recipe, no fire—just bread that appeared, warm and whole, each dawn.\n" +
    ...
    public static void BookVI(GUI gui){
        title = "Ashes and Ends";
        gui.printBookText("A pot of unmarked clay sat on the altar of a forgotten sect.\n" +
